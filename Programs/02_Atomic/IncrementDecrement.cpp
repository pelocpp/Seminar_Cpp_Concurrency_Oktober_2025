...
namespace IncrementDecrement {
    ...
    constexpr long NumIterations{ 5'000'000 };

    class IncDec {

    private:
        long m_counter{};   // <========== agieren 2 oder mehr Threads

        std::atomic<long> m_counterAtomic;

        std::mutex m_mutex;  // Dies ist ein Mutex Objekt
    ...
    private:
        ...
        void incrementMutex() {
            ...
            for (size_t n{}; n != NumIterations; ++n) {
                ...
                //if (n == 9'999) {
                //    m_mutex.unlock();
                //    break;  // da stimmt was nicht, will vorzeitig raus
                //}
        ...
        void incrementMutexRAII() {
            ...
            for (size_t n{}; n != NumIterations; ++n) {
                ...
                std::lock_guard<std::mutex> guard{ m_mutex };  // guard ist eine Hülle
                                                               // Konstruktor: std::lock_guard ==> lock                                           
            ...
            } // Destruktor: std::lock_guard ==> unlock
